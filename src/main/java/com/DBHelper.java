...
public class DBHelper {
    ...
    public Restaurant createRestaurant(Restaurant r) {
        try (Connection c = getConnection();
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                return new Restaurant(rs.getInt("id"), r.getName(), r.getAddress(), r.getPhone());
            }
        } catch (SQLException e) { e.printStackTrace(); }
        return null;
    }
    ...
    public MenuItem createMenuItem(MenuItem item) {
        try (Connection c = getConnection();
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                return new MenuItem(rs.getInt("id"), item.getName(), item.getPrice(), item.getCategory());
            }
        } catch (SQLException e) { e.printStackTrace(); }
        return null;
    }
    ...
    public List<Order> getAllOrders() {
        ...
        try (Connection c = getConnection();
            ...
            while (rs.next()) {
                list.add(new Order(rs.getInt("id"), rs.getString("customer_name"),
    ...
    public Order getOrderById(int id) {
        try (Connection c = getConnection();
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                return new Order(rs.getInt("id"), rs.getString("customer_name"),
                        rs.getDouble("total_amount"), rs.getString("status"));
            }
        } catch (SQLException e) { e.printStackTrace(); }
        return null;
    ...
    public Order createOrder(Order order) {
        try (Connection c = getConnection();
            ...
            ResultSet rs = ps.executeQuery();
            if (rs.next()) {
                return new Order(rs.getInt("id"), order.getCustomerName(),
